...
?>
  ...
  <section id="about" class="py-5 bg-white">
    <div class="container">
      <h2 class="text-center mb-4">Замена молнии</h2>
      <p class="text-center">Ознакомтесь с услугами из категории "Замена молнии"</p>
    </div>
  </section>
...
$mysql = 'SELECT * FROM service WHERE categoriesID = 5';
...
<div class="container mt-4 category_card">
  <div class="row">
   <table class="table table-borderless table-success table-light">
    ...
    <div class="col-md-4 mb-4">
      <div class="position-relative text-center">
        <form class="row justify-content-center" method="post" action="app/controllers/zamenamolni.php">
          <tr>
            <th scope="col">
              <div class="">
