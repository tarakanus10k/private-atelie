...
?>
  ...
  <section id="about" class="py-5 bg-white">
    <div class="container">
      <h2 class="text-center mb-4">Латки Штопка</h2>
      <p class="text-center">Ознакомтесь с услугами из категории "Латки Штопка"</p>
    </div>
  </section>
...
$mysql = 'SELECT * FROM service WHERE categoriesID = 3';
